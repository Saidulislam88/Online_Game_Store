...
<head>
		<title>Gaming Pain | Ultimate Gaming</title>
		<meta charset="utf-8">
							...
							<div class="row clearfix">
								<div class="col-lg-6 col-md-6 col-sm-6 t_align_r t_xs_align_c m_xs_bottom_15">
									<dl class="l_height_medium">
										...
										<dd class="f_size_ex_large color_dark"><b>+22 4569 256</b></dd>
									</dl>
								</div>
							...
							<ul class="horizontal_list main_menu clearfix">
								...
								<li class="relative f_xs_none m_xs_bottom_5"><a href="contact.php" class="tr_delay_hover color_light tt_uppercase"><b>Contact</b></a></li>
								 ...
								 <?php if (isset($_SESSION["login_check"]) ==1) { ?>
                                   ...
                                   <li class="relative f_xs_none m_xs_bottom_5"><a href="logout.php" class="tr_delay_hover color_light tt_uppercase"><b>
                                   Logout</b></a></li>

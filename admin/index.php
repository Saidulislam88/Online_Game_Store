					...
					<form class="form-horizontal" action="" method="POST">
						<fieldset>
							...
							<div class="input-prepend" title="Username">
								...
								<input class="input-large span10" name="admin_email_address" id="admin_email_address" type="admin_email_address" placeholder="Enter Email Address" autocomplete="off" required />
							</div>
							<div class="clearfix"></div>

							<div class="input-prepend" title="Password">
								<span class="add-on"><i class="halflings-icon lock"></i></span>
								<input class="input-large span10" name="admin_password" id="admin_password" type="password" placeholder="Enter Password" autocomplete="off" required/>
							</div>
							<div class="clearfix"></div>
